...
export function mediationLifecycle(a: ApplicationRecord, tasks: Task[], expected: LifecycleBranch = "SETTLEMENT") {
  ...
  const settlement: Draft[] = [
    S("settlement", "MEDIATOR", B("নিষ্পত্তি রেকর্ড", "Settlement recorded"), B("মধ্যস্থতাকারী পক্ষদের সম্মত শর্ত লেখেন — কোনো AI শর্ত বা টাকার অঙ্ক প্রস্তাব করে না। এখনো চূড়ান্ত নয়।", "The mediator writes the terms the parties agreed — no AI proposes terms or amounts. Not final yet."),
    ...
    S("testimonial", "OFFICER", B("নিষ্পত্তি প্রত্যয়নপত্র (টেস্টিমোনিয়াল)", "Settlement testimonial"), B("যাচাইয়ের পর DLO নিষ্পত্তির প্রত্যয়নপত্র তৈরি করেন — চুক্তি, পক্ষ, মধ্যস্থতাকারী ও যাচাইয়ের রেকর্ড।", "After verifying, the DLO generates the settlement testimonial — the agreement, parties, mediator and verification on record."),
    ...
    S("closed", "SYSTEM", B("কেস বন্ধ", "Case closed"), B("প্রত্যয়নপত্র ইস্যু হলে কেস বন্ধ হয়; নাগরিককে জানানো হয় এবং তিনি নিজের পাতায় ফলাফল দেখেন।", "Issuing the testimonial closes the case; the citizen is told and sees the outcome on their page."),
      !!flow?.testimonial && !!a.closedAt, "COMPLETED", "COMPLETED", find(a, "case.closed"), [`application status: ${words(a.status)}`, a.closedAt ? "closed" : null], "/dashboard/citizen"),
  ];
