...
export function seedDemoData(envelope: StoreEnvelope): StoreEnvelope {
  ...
  const rahelaDraftClauses = [
    { clauseId: "maintenance-1", titleBn: "পক্ষগণ", titleEn: "Parties", bodyBn: "প্রদানকারী: করিম উদ্দিন। গ্রহীতা: রাহেলা বেগম।", bodyEn: "Payer: Karim Uddin. Payee: Rahela Begum.", origin: "template" as const, required: true, disposition: "accept" as const, dispositionedBy: "mediator", dispositionedAt: "2026-08-12T13:20:00.000Z" },
    { clauseId: "maintenance-2", titleBn: "মাসিক ভরণপোষণ", titleEn: "Monthly maintenance", bodyBn: "প্রদানকারী প্রতি মাসে ৫,০০০ টাকা মাসের ৫ তারিখে মোবাইল ব্যাংকিং-এর মাধ্যমে পরিশোধ করবেন।", bodyEn: "The payer shall pay 5000 BDT each month on the 5th, via mobile banking.", origin: "ai_inferred" as const, sourceNote: "Amount, payment date, and method extracted from the mediator's session notes.", required: true, disposition: "accept" as const, dispositionedBy: "mediator", dispositionedAt: "2026-08-12T13:20:00.000Z" },
    {
    ...
    { clauseId: "maintenance-4", titleBn: "পর্যালোচনার তারিখ", titleEn: "Review date", bodyBn: "এই ব্যবস্থা ২০২৭-০২-১২-এ পর্যালোচনা করা হবে।", bodyEn: "This arrangement will be reviewed on 2027-02-12.", origin: "ai_inferred" as const, required: true, disposition: "accept" as const, dispositionedBy: "mediator", dispositionedAt: "2026-08-12T13:20:00.000Z" },
    { clauseId: "maintenance-5", titleBn: "অ-পরিশোধের ফলাফল", titleEn: "Default consequence", bodyBn: "ধারাবাহিক অ-পরিশোধ হলে বিষয়টি মানবিক পর্যালোচনার জন্য ফিরিয়ে আনা হবে।", bodyEn: "Repeated non-payment returns this matter to human review; there is no automatic penalty.", origin: "template" as const, required: true, disposition: "accept" as const, dispositionedBy: "mediator", dispositionedAt: "2026-08-12T13:20:00.000Z" },
  ];
  ...
  return {
    ...
    offlineDrafts: [] as typeof offlineDrafts,
    syncConflicts: [] as typeof syncConflicts,
    integrityVerifications: [] as typeof integrityVerifications,
    performanceMeasurements: [] as typeof performanceMeasurements,
    assistedIntakes: [] as typeof assistedIntakes,
    idMappings: [] as typeof idMappings,
    referrals,
    sensitiveEvidence,
    authorityDirectory,
    legalBasis,
